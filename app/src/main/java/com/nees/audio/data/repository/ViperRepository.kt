package com.nees.audio.data.repository
...
import com.nees.audio.data.dao.DeviceSettingsDao
import com.nees.audio.data.dao.DsPresetDao
import com.nees.audio.data.dao.EqPresetDao
import com.nees.audio.data.dao.PresetDao
        ...
        suspend fun ensureV2Initialized() {
            ...
            initMutex.withLock {
                ...
                dataStore.edit { prefs ->
                    ...
                    prefs[booleanPreferencesKey(PREF_MASTER_ENABLE)] = true
                    prefs[booleanPreferencesKey(PREF_GLOBAL_MODE)] = true
                    prefs[booleanPreferencesKey(PREF_AUTO_START)] = true
                }
                initDone = true
            }
        }
